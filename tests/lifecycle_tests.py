...
class Teststate_goto(unittest.TestCase):
    ...
    def test_state_goto_path(self):
        ...
        lf.state_goto(S4,{})
        self.assertEqual(lf.state_goto_path(S1),[(S4(),"leave"),(S3(),"leave"),(S2(),"leave")])
...
class TestComplex(unittest.TestCase):
    ...
    def test_provide_call(self):
        self.assertEqual(self.lf.provide_list()[0][1][0].name,"p1_s2")
        self.assertDictContainsSubset(self.lf.provide_call_requires("p1_s2")[0].to_primitive(),{'name': 'r1_s2','type': 'simple','args': [{ 'type': 'str','name': 'r1_s2'}]})


        self.assertEqual(self.lf.provide_call("p1_s2",{'r1_s2':[{'r1_s2':"test"}]},{}),"ret_p1_s2")
    ...
    def test_ambigous(self):
        ...
        self.assertEqual(self.lf.provide_call("C4.p_ambigous",{'r1_s2':[{'r1_s2':"test"}]},{}),"p_ambigous_s4")
        self.assertEqual(self.lf.state_current(),C4())
...
class TestRequires(unittest.TestCase):
    ...
    def test_require_simple(self):
        ...
        self.assertDictContainsSubset(self.lf.state_goto_requires("S_R1")[0].to_primitive(),{'args': [{'name': 'var_S_R1_1', 'type': 'str'}],
                                                                        'name': 'var_S_R1_1',
                                                                        'type': 'simple'
                                                                        })
    ...
    def test_require_external(self):
        ...
        self.lf.state_goto("S_R2",{"module_S_R2.provide_S_R2":[{'var_S_R2_1':'test', 'var_S_R2_1':'test2','host':'test_host'}]})
    ...
    def test_require_local(self):
        ...
        self.assertEqual(self.lf.state_goto_requires("S_R3")[0].to_primitive(),
                         {'args': [{'name': 'var_S_R3_1', 'type': 'str'}],
                          ...
                          'type': 'local'})
        self.lf.state_goto("S_R3",{"module_S_R3.provide_S_R3":[{'var_S_R3_1':'test'}]})
