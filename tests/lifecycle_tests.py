...
class S1(mss.lifecycle.State):pass
class S2(mss.lifecycle.State):
    @mss.lifecycle.provide()
    def p1_s2(self):
        return "ret_p1_s2"
class S3(mss.lifecycle.State):pass
class S4(mss.lifecycle.State):pass
class S5(mss.lifecycle.State):pass
...
class Testgoto_state(unittest.TestCase):
    def setUp(self):
        self.lf=Simple()

    def test_get_state_path(self):
        lf=Simple()
        path=lf.get_state_path("S4")
        self.assertEqual(path,[(S2(),"entry"),(S3(),"entry"),(S4(),"entry")])
        lf.goto_state(S4,{})
        self.assertEqual(lf.get_state_path(S1),[(S4(),"leave"),(S3(),"leave"),(S2(),"leave")])
        self.assertEqual(lf.get_state_path(S1,go_back=False),[])

    def test_goto_state(self):
        lf=Simple()
        lf.goto_state(S4,{})
        path=lf.get_state_path(S1)
        self.assertEqual(path,[(S4(),"leave"),(S3(),"leave"),(S2(),"leave")])

    def test_idempotence(self):
        lf=Simple()
        lf.goto_state(S4,{})
        self.assertEqual(lf.get_state_path(S4),[])


    def test_get_state_pathBack(self):
        self.lf.goto_state(S4,{"r1_s2":"value_r1_s2"})
        self.assertEqual(self.lf.get_current_state(),S4())
        self.lf.goto_state(S3,{})
        self.assertEqual(self.lf.get_current_state(),S3())




class C1(mss.lifecycle.State):pass
...
class C5(mss.lifecycle.State):pass
...
class TestComplex(unittest.TestCase):
    ...
    def test_get_state_path(self):
        path=self.lf.get_state_path("C3")
    ...
    def test_missing_require(self):
        ...
        self.assertEqual(self.lf.get_current_state(),C1())
    ...
    def test_get_state_pathBack(self):
        self.lf.goto_state(C4,{'r1_s2':[{'r1_s2':"test"}]})
        path=self.lf.get_state_path(C1)
        self.assertEqual(path,[(C4(),"leave"),(C3(),"leave"),(C2(),"leave")])
        path=self.lf.get_state_path(C5)
    ...
    def test_provide_get_state_path(self):
        self.assertEqual(self.lf.get_provide_path("p1_s2"),[(C2(),'entry')])
        self.lf.goto_state(C3,{'r1_s2':[{'r1_s2':"test"}]})
        self.assertEqual(self.lf.get_provide_path("p1_s2"),[])
...
# TEST REQUIRES
################################################################################
class S_R0(mss.lifecycle.State):pass
class S_R1(mss.lifecycle.State):
    requires=[mss.require.Require([mss.require.VString("var_S_R1_1")])]
class S_R2(mss.lifecycle.State):
    requires=[mss.require.RequireExternal("module_S_R2","provide_S_R2",[mss.require.VString("var_S_R2_1"),mss.require.VString("var_S_R2_1")])]
class S_R3(mss.lifecycle.State):
    requires=[mss.require.RequireLocal("module_S_R3","provide_S_R3",[mss.require.VString("var_S_R3_1")])]
...
class TestRequires(unittest.TestCase):
    ...
    def test_require_simple(self):
        with self.assertRaises(mss.require.MissingRequire):
            self.lf.goto_state("S_R1",{})
        self.assertDictContainsSubset(self.lf.get_state_requires("S_R1")[0].to_primitive(),{'args': [{'name': 'var_S_R1_1', 'type': 'str'}],
                                                                        'name': 'var_S_R1_1',
                                                                        'type': 'simple'
                                                                        })


        self.lf.goto_state("S_R1",{"var_S_R1_1":[{"var_S_R1_1":"test"}]})
        self.assertEqual(self.lf.get_current_state(),S_R1())

    def test_require_external(self):
        with self.assertRaises(mss.require.MissingRequire):
            self.lf.goto_state("S_R2",{})
        self.assertEqual(self.lf.get_state_requires("S_R2")[0].to_primitive(),
        ...
        self.lf.goto_state("S_R2",{"module_S_R2.provide_S_R2":[{'var_S_R2_1':'test', 'var_S_R2_1':'test2','host':'test_host'}]})
        self.assertEqual(self.lf.get_current_state(),S_R2())

    def test_require_local(self):
        with self.assertRaises(mss.require.MissingRequire):
            self.lf.goto_state("S_R3",{})
        self.assertEqual(self.lf.get_state_requires("S_R3")[0].to_primitive(),
                         {'args': [{'name': 'var_S_R3_1', 'type': 'str'}],
                          'module': 'module_S_R3',
                          'name': 'module_S_R3.provide_S_R3',
                          'provide': 'provide_S_R3',
                          'type': 'local'})
        self.lf.goto_state("S_R3",{"module_S_R3.provide_S_R3":[{'var_S_R3_1':'test'}]})
        self.assertEqual(self.lf.get_current_state(),S_R3())
