...
echo "Generating svg file for all MSS3 modules"
...
echo "MSS3 modules documentation" >> ${rst_module_file}
echo "==========================" >> ${rst_module_file}
...
do 
    ...
    python -c "import mss.modules.${module}  ; print mss.modules.${module}.lifecycle.${lifecycle}().to_dot()" 2>/dev/null 1>${dot_file_path}
    if [ $? -eq 0 ]
    then
